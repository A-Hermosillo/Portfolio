...
if __name__ == '__main__':
    ...
    while t > 0.005 and cost0 > 0:
        ...
        nachbarn = np.random.choice(neighbors_p)
        ...
        if new_cost < cost0:
            ...
            # Calculate the probability of accepting the new neighbor
            p = math.exp(-(new_cost - cost0)/t)
        ...
        print('Iteration: ', step, "    Cost: ", cost0, "   Temperature: ", t)

# Coordenada final del recorrido

print("-" * 55)
print("Coord final dentro de la matriz (x,y): ", path_x[-1], ",", path_y[-1])

# Altura del punto final
print("-" * 55)
print("Altura final:", crater_map[path_y[-1], path_x[-1]], "metros")
